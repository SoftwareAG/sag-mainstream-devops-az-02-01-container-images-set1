...
huntForSuifFile "05.docker-image-builders/MSR/1015/msr-jdbc-custom-builder-01" "Dockerfile" || exit 1
huntForSuifFile "05.docker-image-builders/MSR/1015/msr-jdbc-custom-builder-01" "install.sh" || exit 2

logI "Preparing the build context..."
mkdir /tmp/build_context

mv "${SUIF_CACHE_HOME}/05.docker-image-builders/MSR/1015/msr-jdbc-custom-builder-01/"* /tmp/build_context/
